            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <label>
                        ...
                        {/* <input onChange={this.handleChange("birthdate")} type="text" value={this.state.birthdate} /> */}
                    </label>
                    <br />
                    <label>
                        Gender:
                        ...
                        {/* <input onChange={this.handleChange("gender")} type="text" value={this.state.gender} /> */}
                    </label>
                    <br />
