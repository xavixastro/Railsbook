            ...
            <div className="signup">
                ...
                <form className="signup-form" onSubmit={this.handleSubmit}>
                    <table>
                        ...
                        <tr>
                            <td><input onChange={this.handleChange("first_name")} placeholder="First name" type="text" value={this.state.first_name} /></td>
                            <td><input onChange={this.handleChange("last_name")} placeholder="Last name" type="text" value={this.state.last_name} /></td>
                        </tr>
                        <tr>
